...
public abstract class GenInputsAbstract extends CommandHandler {
  ...
  /** csit6910: extension to generate template for parameterized unit tests and theory */
  @Option("Write junit default test")
  public static boolean junit_write_default_test = true;
  
  @Option("Write junit template theory test")
  public static boolean junit_write_theory_test = false;
  
  @Option("Write junit template parameterized test")
  public static boolean junit_write_parameterized_test = false;

  @Option("parameters per file for junit parameterized test")
  public static int junit_parameters_per_file = 10;

  @Option("Write JPF test driver (Experimental)")
  public static boolean jpf_write_test_driver = false;

  @Option("Write Janala2 test driver (Experimental)")
  public static boolean janala_write_test_driver = false;

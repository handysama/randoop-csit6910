  ...
  public RandoopLaunchConfigurationWizard(IJavaProject javaProject,
    ...
    if (RandoopPreferences.doRememberParameters(store)) {
      ...
      case RandoopPreferences.WORKSPACE:
        ...
        /** csit6910 */
        setConfigAttribute(store, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_TEST_TYPES);
        setConfigAttribute(store, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_DEFAULT_TEST);
        setConfigAttribute(store, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_THEORY_TEST);
        setConfigAttribute(store, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_PARAMETERIZED_TEST);
        setConfigAttribute(store, IRandoopLaunchConfigurationConstants.ATTR_JPF_WRITE_TEST_DRIVER);
        setConfigAttribute(store, IRandoopLaunchConfigurationConstants.ATTR_JANALA_WRITE_TEST_DRIVER);
      ...
      case RandoopPreferences.PROJECT:
        ...
        /** csit6910 */ 
        setConfigAttribute(prefs, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_DEFAULT_TEST,IRandoopLaunchConfigurationConstants.DEFAULT_JUNIT_WRITE_DEFAULT_TEST);
        setConfigAttribute(prefs, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_THEORY_TEST,IRandoopLaunchConfigurationConstants.DEFAULT_JUNIT_WRITE_THEORY_TEST);
        setConfigAttribute(prefs, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_PARAMETERIZED_TEST,IRandoopLaunchConfigurationConstants.DEFAULT_JUNIT_WRITE_PARAMETERIZED_TEST);
        setConfigAttribute(prefs, IRandoopLaunchConfigurationConstants.ATTR_JPF_WRITE_TEST_DRIVER,IRandoopLaunchConfigurationConstants.DEFAULT_JPF_WRITE_TEST_DRIVER);
        setConfigAttribute(prefs, IRandoopLaunchConfigurationConstants.ATTR_JANALA_WRITE_TEST_DRIVER,IRandoopLaunchConfigurationConstants.DEFAULT_JANALA_WRITE_TEST_DRIVER);
  ...
  public boolean performFinish() {
    ...
    if (RandoopPreferences.doRememberParameters(store)) {
      ...
      case RandoopPreferences.WORKSPACE:        
        ...
        /** csit6910 */
        setValueFromConfig(store, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_DEFAULT_TEST,IRandoopLaunchConfigurationConstants.DEFAULT_JUNIT_WRITE_DEFAULT_TEST);
        setValueFromConfig(store, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_THEORY_TEST,IRandoopLaunchConfigurationConstants.DEFAULT_JUNIT_WRITE_THEORY_TEST);
        setValueFromConfig(store, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_PARAMETERIZED_TEST,IRandoopLaunchConfigurationConstants.DEFAULT_JUNIT_WRITE_PARAMETERIZED_TEST);
        setValueFromConfig(store, IRandoopLaunchConfigurationConstants.ATTR_JPF_WRITE_TEST_DRIVER,IRandoopLaunchConfigurationConstants.DEFAULT_JPF_WRITE_TEST_DRIVER);
        setValueFromConfig(store, IRandoopLaunchConfigurationConstants.ATTR_JANALA_WRITE_TEST_DRIVER,IRandoopLaunchConfigurationConstants.DEFAULT_JANALA_WRITE_TEST_DRIVER);
      ...
      case RandoopPreferences.PROJECT:
        ...
        /** csit6910 */ 
        setValueFromConfig(prefs, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_DEFAULT_TEST,IRandoopLaunchConfigurationConstants.DEFAULT_JUNIT_WRITE_DEFAULT_TEST);
        setValueFromConfig(prefs, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_THEORY_TEST,IRandoopLaunchConfigurationConstants.DEFAULT_JUNIT_WRITE_THEORY_TEST);
        setValueFromConfig(prefs, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_PARAMETERIZED_TEST,IRandoopLaunchConfigurationConstants.DEFAULT_JUNIT_WRITE_PARAMETERIZED_TEST);
        setValueFromConfig(prefs, IRandoopLaunchConfigurationConstants.ATTR_JPF_WRITE_TEST_DRIVER,IRandoopLaunchConfigurationConstants.DEFAULT_JPF_WRITE_TEST_DRIVER);
        setValueFromConfig(prefs, IRandoopLaunchConfigurationConstants.ATTR_JANALA_WRITE_TEST_DRIVER,IRandoopLaunchConfigurationConstants.DEFAULT_JANALA_WRITE_TEST_DRIVER);

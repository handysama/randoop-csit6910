...
//    
//    junitTestTypesLabel.setToolTipText(RandoopMessages.RandoopOption_junit_test_types_tooltip);
//    junitTestTypesCombo.setToolTipText(RandoopMessages.RandoopOption_junit_test_types_tooltip);
    // ------------------------
...
//    data.left = new FormAttachment(0, INDENTATION);
//    junitTestTypesLabel.setLayoutData(data);
//
//    data = new FormData();
//    data.top = new FormAttachment(outputParametersTitle, VERTICAL_TEXT_SPACING);
//    data.left = new FormAttachment(junitTestTypesLabel);
//    junitTestTypesCombo.setLayoutData(data);
//    
//    options.add(new JUnitTestTypesOption(junitTestTypesCombo));
    // -----------------
  ...
  public static List<IOption> createAdvancedOptionGroupPlaceholders() {
    ...
    // csit6910
    options.add(new JUnitNormalTestOption());
    options.add(new JUnitTheoryTestOption());
    options.add(new JUnitParameterizedTestOption());
    options.add(new JPFTestOption());
    options.add(new JanalaTestOption());
  ...
  public static List<IOption> createAdvancedOptionGroup(Composite parent,
    ...
    /** csit6910 */
//    comp = SWTFactory.createComposite(comp, 4, 1, GridData.FILL_BOTH);
//    ld = (GridLayout) comp.getLayout();
//    ld.numColumns = 4;
//    ld.marginLeft = 0;
//    ld.marginLeft = INDENTATION;
    
    //	new Label(comp, SWT.HORIZONTAL|SWT.LEAD);
    Label junitTestTypesLabel = SWTFactory.createLabel(comp, RandoopMessages.RandoopOption_junit_test_types, 1);
    junitTestTypesLabel.setToolTipText(RandoopMessages.RandoopOption_junit_test_types_tooltip);

    Button junitNormalTestButton = SWTFactory.createCheckButton(comp, 
    		RandoopMessages.RandoopOption_junit_write_normal_test, null, false, 1);
    junitNormalTestButton.setToolTipText(RandoopMessages.RandoopOption_junit_write_normal_testtooltip);
    IOption junitNormalTest = new JUnitNormalTestOption(junitNormalTestButton);
    
    Label dummy1 = SWTFactory.createLabel(comp, "", 1);
    Button junitTheoryTestButton = SWTFactory.createCheckButton(comp, 
    		RandoopMessages.RandoopOption_junit_write_theory_test, null, false, 1);
    junitTheoryTestButton.setToolTipText(RandoopMessages.RandoopOption_junit_write_theory_test_tooltip);
    IOption junitTheoryTest = new JUnitTheoryTestOption(junitTheoryTestButton);
    
    Label dummy2 = SWTFactory.createLabel(comp, "", 1);
    Button junitParameterizedTestButton = SWTFactory.createCheckButton(comp, 
    		RandoopMessages.RandoopOption_junit_write_parameterized_test, null, false, 1);
    junitParameterizedTestButton.setToolTipText(RandoopMessages.RandoopOption_junit_write_parameterized_test_tooltip);
    IOption junitParameterizedTest = new JUnitParameterizedTestOption(junitParameterizedTestButton);


//    comp = SWTFactory.createComposite(comp, 3, 3, GridData.FILL_BOTH);
//    ld = (GridLayout) comp.getLayout();
//    ld.numColumns = 3;
//    ld.marginLeft = 0;
//    ld.marginLeft = INDENTATION;
    
    Label outputTestDriverLabel = SWTFactory.createLabel(comp, "Test Driver (Experimental):", 1);
    outputTestDriverLabel.setToolTipText("");

    Button jpfCheckButton = SWTFactory.createCheckButton(comp,
    		RandoopMessages.RandoopOption_jpf_write_test_driver, null, false, 1);
    jpfCheckButton.setToolTipText(RandoopMessages.RandoopOption_jpf_write_test_driver_tooltip);
    IOption jpfTest = new JPFTestOption(jpfCheckButton);

    Label lblDummy3 = SWTFactory.createLabel(comp, "", 1);
    Button janalaCheckButton = SWTFactory.createCheckButton(comp,
    		RandoopMessages.RandoopOption_janala_write_test_driver, null, false, 1);
    janalaCheckButton.setToolTipText(RandoopMessages.RandoopOption_janala_write_test_driver_tooltip);
    IOption janalaTest = new JanalaTestOption(janalaCheckButton);
 ...
 // addOption(fMaxTestsWritten);
    ...
    /** csit6910 */
    options.add(junitNormalTest);
    options.add(junitTheoryTest);
    options.add(junitParameterizedTest);
    options.add(jpfTest);
    options.add(janalaTest);
  ...
  /** csit6910 */
  private static class JUnitNormalTestOption extends ButtonOption {

	  public JUnitNormalTestOption() {
	  }

	  public JUnitNormalTestOption(Button button) {
		  super(button);
	  }
	  ...
	  protected IStatus validate(boolean b) {
		  try {
			  ...
			  return RandoopStatus.createUIStatus(IStatus.ERROR, "Input must be boolean.");
		  }
	  }
	  ...
	  @Override
	  protected String getAttributeName() {
		  return IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_DEFAULT_TEST;
	  }

	  @Override
	  protected boolean getDefaultValue() {
		  return Boolean.parseBoolean(IRandoopLaunchConfigurationConstants.DEFAULT_JUNIT_WRITE_DEFAULT_TEST);
	  }

  }
  
  private static class JUnitTheoryTestOption extends ButtonOption {

	  public JUnitTheoryTestOption() {
	  }

	  public JUnitTheoryTestOption(Button button) {
		  super(button);
	  }
	  ...
	  @Override
	  protected String getAttributeName() {
		  return IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_THEORY_TEST;
	  }

	  @Override
	  protected boolean getDefaultValue() {
		  return Boolean.parseBoolean(IRandoopLaunchConfigurationConstants.DEFAULT_JUNIT_WRITE_THEORY_TEST);
	  }

  }
  
  private static class JUnitParameterizedTestOption extends ButtonOption {

	  public JUnitParameterizedTestOption() {
	  }

	  public JUnitParameterizedTestOption(Button button) {
		  super(button);
	  }
	  ...
	  @Override
	  protected String getAttributeName() {
		  return IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_PARAMETERIZED_TEST;
	  }

	  @Override
	  protected boolean getDefaultValue() {
		  return Boolean.parseBoolean(IRandoopLaunchConfigurationConstants.DEFAULT_JUNIT_WRITE_PARAMETERIZED_TEST);
	  }

  }
    
  private static class JanalaTestOption extends ButtonOption {

	  public JanalaTestOption() {
	  }

	  public JanalaTestOption(Button button) {
		  super(button);
	  }
	  ...
	  protected IStatus validate(boolean b) {
		  try {
			  ...
			  return RandoopStatus.createUIStatus(IStatus.ERROR, "Test Types must be ...");
		  }
	  }
	  ...
	  @Override
	  protected String getAttributeName() {
		  return IRandoopLaunchConfigurationConstants.ATTR_JANALA_WRITE_TEST_DRIVER;
	  }

	  @Override
	  protected boolean getDefaultValue() {
		  return Boolean.parseBoolean(IRandoopLaunchConfigurationConstants.DEFAULT_JANALA_WRITE_TEST_DRIVER);
	  }

  }
  
  private static class JPFTestOption extends ButtonOption {

	  public JPFTestOption() {
	  }

	  public JPFTestOption(Button button) {
		  super(button);
	  }
	  ...
	  @Override
	  protected String getAttributeName() {
		  return IRandoopLaunchConfigurationConstants.ATTR_JPF_WRITE_TEST_DRIVER;
	  }

	  @Override
	  protected boolean getDefaultValue() {
		  return Boolean.parseBoolean(IRandoopLaunchConfigurationConstants.DEFAULT_JPF_WRITE_TEST_DRIVER);
	  }

...
public class IRandoopLaunchConfigurationConstants {
  ...
  /** csit6910 : extension for generate template for PUTS and Theory */
  public static final String ATTR_JUNIT_TEST_TYPES = RandoopPlugin.getPluginId() + ".JUNIT_TEST_TYPES"; //$NON-NLS-1$
  
  public static final String ATTR_JUNIT_WRITE_DEFAULT_TEST = RandoopPlugin.getPluginId() + ".JUNIT_WRITE_DEFAULT_TEST"; //$NON-NLS-1$
  
  public static final String ATTR_JUNIT_WRITE_THEORY_TEST = RandoopPlugin.getPluginId() + ".JUNIT_WRITE_THEORY_TEST"; //$NON-NLS-1$
  
  public static final String ATTR_JUNIT_WRITE_PARAMETERIZED_TEST = RandoopPlugin.getPluginId() + ".JUNIT_WRITE_PARAMETERIZED_TEST"; //$NON-NLS-1$
  
  public static final String ATTR_JPF_WRITE_TEST_DRIVER = RandoopPlugin.getPluginId() + ".JPF_WRITE_TEST_DRIVER"; //$NON-NLS-1$
  
  public static final String ATTR_JANALA_WRITE_TEST_DRIVER = RandoopPlugin.getPluginId() + ".JANALA_WRITE_TEST_DRIVER"; //$NON-NLS-1$
  
  public static final String ATTR_JUNIT_PARAMETERS_PER_FILE = RandoopPlugin.getPluginId() + ".JUNIT_PARAMETERS_PER_FILE"; //$NON-NLS-1$
  ...
  /** csit6910 : extension for generate template for PUTS and Theory */
  public static final String DEFAULT_JUNIT_WRITE_DEFAULT_TEST = "true"; //$NON-NLS-1$

  public static final String DEFAULT_JUNIT_WRITE_THEORY_TEST = "false"; //$NON-NLS-1$
  
  public static final String DEFAULT_JUNIT_WRITE_PARAMETERIZED_TEST = "false"; //$NON-NLS-1$
  
  public static final String DEFAULT_JPF_WRITE_TEST_DRIVER = "false"; //$NON-NLS-1$
  
  public static final String DEFAULT_JANALA_WRITE_TEST_DRIVER = "false"; //$NON-NLS-1$
  
  public static final String DEFAULT_JUNIT_PARAMETERS_PER_FILE = "50"; //$NON-NLS-1$

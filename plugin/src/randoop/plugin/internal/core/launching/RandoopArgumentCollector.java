...
public class RandoopArgumentCollector {
  ...
  /** csit6910 */
  private boolean fJUnitWriteDefaultTest;
  private boolean fJUnitWriteTheoryTest;
  private boolean fJUnitWriteParameterizedTest;
  private boolean fJPFWriteTestDriver;
  private boolean fJanalaWriteTestDriver;
  private int fJUnitParametersPerFile;
  ...
  public RandoopArgumentCollector(ILaunchConfiguration config, IWorkspaceRoot root) throws CoreException {
    ...
    // TODO: Check validity of these three arguments
    ...
    /** csit6910 */
    fJUnitWriteDefaultTest = getJUnitWriteDefaultTest(config);
    fJUnitWriteTheoryTest = getJUnitWriteTheoryTest(config);
    fJUnitWriteParameterizedTest = getJUnitWriteParameterizedTest(config);
    fJPFWriteTestDriver = getJPFWriteTestDriver(config);
    fJanalaWriteTestDriver = getJanalaWriteTestDriver(config);
    fJUnitParametersPerFile = Integer.parseInt(getJUnitParametersPerFile(config));
  ...
  /** csit6910 */
  public boolean getJUnitWriteDefaultTest() {
	  return fJUnitWriteDefaultTest;
  }
  
  public boolean getJUnitWriteTheoryTest() {
	  return fJUnitWriteTheoryTest;
  }
  
  public boolean getJUnitWriteParameterizedTest() {
	  return fJUnitWriteParameterizedTest;
  }
  
  public boolean getJPFWriteTestDriver() {
	  return fJPFWriteTestDriver;
  }
  
  public boolean getJanalaWriteTestDriver() {
	  return fJanalaWriteTestDriver;
  }
  
  public int getJUnitParametersPerFile() {
	  return fJUnitParametersPerFile;
  }
  ...
  /** csit6910 A */
  public static boolean getJUnitWriteDefaultTest(ILaunchConfiguration config) {
	  return Boolean.parseBoolean(getAttribute(config,
			  IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_DEFAULT_TEST,
			  IRandoopLaunchConfigurationConstants.DEFAULT_JUNIT_WRITE_DEFAULT_TEST));
  }

  public static boolean getJUnitWriteTheoryTest(ILaunchConfiguration config) {
	  return Boolean.parseBoolean(getAttribute(config,
			  IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_THEORY_TEST,
			  IRandoopLaunchConfigurationConstants.DEFAULT_JUNIT_WRITE_THEORY_TEST));
  }

  public static boolean getJUnitWriteParameterizedTest(ILaunchConfiguration config) {
	  return Boolean.parseBoolean(getAttribute(config,
			  IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_PARAMETERIZED_TEST,
			  IRandoopLaunchConfigurationConstants.DEFAULT_JUNIT_WRITE_PARAMETERIZED_TEST));
  }

  public static boolean getJPFWriteTestDriver(ILaunchConfiguration config) {
	  return Boolean.parseBoolean(getAttribute(config,
			  IRandoopLaunchConfigurationConstants.ATTR_JPF_WRITE_TEST_DRIVER,
			  IRandoopLaunchConfigurationConstants.DEFAULT_JPF_WRITE_TEST_DRIVER));
  }

  public static boolean getJanalaWriteTestDriver(ILaunchConfiguration config) {
	  return Boolean.parseBoolean(getAttribute(config,
			  IRandoopLaunchConfigurationConstants.ATTR_JANALA_WRITE_TEST_DRIVER,
			  IRandoopLaunchConfigurationConstants.DEFAULT_JANALA_WRITE_TEST_DRIVER));
  }
  
  public static String getJUnitParametersPerFile(ILaunchConfiguration config) {
	  return getAttribute(config,
			  IRandoopLaunchConfigurationConstants.ATTR_JUNIT_PARAMETERS_PER_FILE,
			  IRandoopLaunchConfigurationConstants.DEFAULT_JUNIT_PARAMETERS_PER_FILE);
  }
  ...
  /** csit6910 */
  public static void setJUnitTestTypes(ILaunchConfigurationWorkingCopy config, String testTypes) {
	  setAttribute(config, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_TEST_TYPES, testTypes);
  }

  public static void setJUnitWriteDefaultTest(ILaunchConfigurationWorkingCopy config, boolean value) {
	  setAttribute(config, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_DEFAULT_TEST, Boolean.toString(value));
  }

  public static void setJUnitWriteTheoryTest(ILaunchConfigurationWorkingCopy config, boolean value) {
	  setAttribute(config, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_THEORY_TEST, Boolean.toString(value));
  }

  public static void setJUnitWriteParameterizedTest(ILaunchConfigurationWorkingCopy config, boolean value) {
	  setAttribute(config, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_WRITE_PARAMETERIZED_TEST, Boolean.toString(value));
  }

  public static void setJPFWriteTestDriver(ILaunchConfigurationWorkingCopy config, boolean value) {
	  setAttribute(config, IRandoopLaunchConfigurationConstants.ATTR_JPF_WRITE_TEST_DRIVER, Boolean.toString(value));
  }

  public static void setJanalaWriteTestDriver(ILaunchConfigurationWorkingCopy config, boolean value) {
	  setAttribute(config, IRandoopLaunchConfigurationConstants.ATTR_JANALA_WRITE_TEST_DRIVER, Boolean.toString(value));
  }
  
  public static void setJUnitParametersPerFile(ILaunchConfigurationWorkingCopy config, String value) {
	  setAttribute(config, IRandoopLaunchConfigurationConstants.ATTR_JUNIT_PARAMETERS_PER_FILE, value);
  }
